import { PokeMetaData } from "@/common/interfaces/pokemon";
                    ...
                    [
                        {
                            title: "Capture rate",
                            value: <>
                                <span title="Chance to capture at full HP with a pokeball" className="sm:underline text-base cursor-help">
                                    {Math.round(captureRate(metaData.details?.captureRate ?? 0) * 10000) / 100}%
                                </span>
                                <span className="-mt-1 sm:hidden col-span-2 text-[0.75rem]">Chance to capture at full HP with a pokeball*</span>
                            </>,
                        },
                        {
                            title: "Egg cycles",
                            value: <span>{metaData.details?.hatchCounter} ({(metaData.details?.hatchCounter ?? 0) * 128} Steps)</span>
                        },
                        {
                            title: "Exp yield",
                            value: <span>{metaData.baseExperience} exp</span>
                        },
                        {
                            title: "Habitat",
                            value: <span>{habitatParser(metaData.habitat)}</span>
                        },
                        {
                            title: "Egg group(s)",
                        ...
                        {
                            title: "Growth rate",
                            value: <span>{RATE[metaData.details?.growthRate ?? ""]}</span>
                        },
                        {
                            title: "Gender ratio",
                            value: (() => {
                        ...
                        },
                        {
                            ...
                            value: <span>{metaData.details?.baseHappiness}</span>
                        },
                        {
                            title: "Weight",
                            value: <span>{metaData.weight / 10}<span className="text-base">kg</span> / {Math.round(metaData.weight * 2.205) / 10}<span className="text-base">lbs.</span></span>
                        },
                        {
                            title: "Height",
                            value: <span>{metaData.height / 10}<span className="text-base">m</span> / {metersToFtIn(metaData.height)}</span>
                        },
                        {
                            title: "Shape",
