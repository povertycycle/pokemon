...
const Genera: React.FC<MythLegendProps> = ({ genera, is_mythical, is_legendary, is_baby }) => {
    ...
    return (
        <div className="shrink-0 w-full h-[32px] text-[1.25rem] leading-6 flex items-center justify-center bg-black/50 border-t-2 text-base-white" style={{ borderColor: palette[0] }}>
