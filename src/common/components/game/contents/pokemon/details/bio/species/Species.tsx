...
const Species: React.FC<SpeciesProps> = ({ varieties, form_description, forms_switchable, genera, is_legendary, is_mythical, is_baby }) => {
            ...
            <div className="transition-width flex flex-col justify-start items-start relative pl-4 pr-2 w-full">
                ...
                <div className={`w-full h-full overflow-hidden flex flex-col gap-4 justify-between relative z-[1] border-x-2 border-b-2 rounded-b-[16px] shadow-base-black`} style={{ borderColor: palette[0] }}>
                    <div className="w-full px-2">
                        <div className="w-full h-full transition-height border-x-2 border-b-2 rounded-b-[16px] pb-4 flex flex-col justify-end items-end gap-2 shadow-base-black" style={{ borderColor: palette[0] }}>
