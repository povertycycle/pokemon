...
const Encounters: React.FC<EncountersProps> = ({ pal_park }) => {
    ...
    return (
        <div id={shortcutID(Shortcuts.Encounters)} className="w-full flex flex-col mt-16 items-center">
            <div className="w-full text-[1.25rem] py-1 flex items-center justify-center px-32 bg-black/50 text-base-white border-y-2 relative" style={{ borderColor: palette[0] }}>
                Encounters
            </div>
