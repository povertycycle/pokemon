...
const Moves: React.FC<MovesProps> = ({ moveVersions }) => {
    return (moveVersions ? <MoveDetails moveVersions={moveVersions} /> : <></>)
}
    ...
    return (
        <div id={shortcutID(Shortcuts.Moves)} className="w-full flex flex-col mt-16 z-[1]">
            <GenerationContext.Provider value={{ gen, setGen }}>
                <div className="w-full text-[1.25rem] py-1 flex items-center justify-center bg-black/50 text-base-white border-y-2 relative" style={{}}>
                    Learnset
