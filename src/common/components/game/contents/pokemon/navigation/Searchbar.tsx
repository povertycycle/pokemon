...
const Searchbar: React.FC<{ search: (pokemon: string) => void }> = ({ search }) => {
    ...
    return (
        <div className="relative text-white flex items-center text-base w-full">
            ...
            <input name="pokemon-name" value={value} className="w-full h-[28px] focus:border-black border-2 border-base-red-dark transition-colors rounded-[14px] bg-base-red-dark px-8" onChange={handleChange} />
